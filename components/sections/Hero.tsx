  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: "linear-gradient(135deg, #1f3b5b 0%, #2980b9 50%, #1a6e5e 100%)" }}>
      ...
      <div className="text-center max-w-3xl px-6 relative z-10">
        ...
        <p className="font-body text-lg md:text-xl text-white/70 leading-relaxed max-w-lg mx-auto mb-10" style={{ animation: "fadeInUp 0.8s ease 0.4s both" }}>Formăm profesioniștii de mâine. 8 profiluri educaționale, 1604 elevi, 155 cadre didactice dedicate excelenței.</p>
